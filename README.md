...
|---|----------|-----------------|------------------------------|-------------------|-------------------|
| 1 | What academic support resources does Amherst list for students? | Should cite Amherst’s academic support page and mention the writing center, the strategic learning center, Frost Library resources, etc | It identified Amherst academic support resources including the Writing Center, Q Center, library research assistance, and other academic-support offices that help students with writing, research, quantitative skills, etc. | Relevant | Accurate |
| 2 | What do students say about Amherst social life or campus community? | Students report that Amherst's social life is heavily clique-based, with limited interaction between groups, occasional feelings of isolation, and a strong work-hard/play-hard culture centered around parties and campus traditions. | Explained that students view Amherst social life as clique-based and sometimes isolating, with limited interaction between groups and a strong "work hard, play hard" culture. It also noted that official Amherst sources describe the campus as having a strong sense of community. | Relevant | Accurate|
...
I would add a clarification step before generation for ambiguous questions that involved eligibility, personal status, or user-specific circumstances. The system could perhaps ask follow-up questions when the retrieved documents don't contain enough information to answer for a particular user
